    ...
    <div className="px-3 sm:px-4 md:px-6 py-6 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8">
        <div>
          ...
          {isPrestador && (
            <p className="text-xs sm:text-sm mt-0.5" style={{ color: text2 }}>Gere os teus serviços publicados</p>
          )}
        </div>
        <div className="flex items-center gap-3">
          {isPrestador && (
            <Link
              ...
              className="flex items-center gap-1.5 text-xs sm:text-sm font-semibold px-3 sm:px-4 py-2 rounded-xl transition-all text-white flex-shrink-0 whitespace-nowrap"
            ...
            >
              ...
              <span className="hidden xs:inline">Criar serviço</span>
      ...
      {!isLoading && baseServices.length > 0 && (
        <div className="relative mb-5 sm:mb-6">
          <span className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2" style={{ color: text2 }}>
          ...
          <input
            ...
            className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 rounded-xl text-sm outline-none transition-all"
